...
%define dist_suffix         %{?dist}
%define sope_buildcount     1
%define sope_source         %{name}-%{sope_version}.tar.gz
%define sope_makeflags      -j
%define sbjson_major_version 2
%define sbjson_version       2.3.1
%define git_shorthash        8f48ab7f
%define date                 20180316

Summary:      SOPE
Name:         sope%{sope_major_version}%{sope_minor_version}
Version:      %{sope_version}
Release:      %{sope_buildcount}.%{date}git%{git_shorthash}%{dist_suffix}
...
# ********************************* changelog *************************
%changelog
* Fri Mar 16 2018 Levente Tamas <levente.tamas@offcode.fi>
- added Fedora rpmbuild spec
